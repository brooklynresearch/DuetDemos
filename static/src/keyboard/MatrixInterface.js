...
import {MatrixElement} from 'keyboard/MatrixElement'
import buckets from 'buckets-js'
import {Midi} from 'keyboard/Midi'
import Buffer from 'Tone/core/Buffer'

class MatrixInterface extends events.EventEmitter{
	constructor(container){
		 ...
		 * The piano interface
		 */
		this._keyboardInterface = new MatrixElement(container, 24, 7) //LOWEST NOTE AND HOW MANY OCTAVES
